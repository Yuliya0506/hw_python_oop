...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:     
        running_calories = (self.factor_1 * self.get_mean_speed() 
                             - self.factor_2) * self.weight / self.M_IN_KM * self.duration * self.W_T_IN_MIN
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:    
        ...
        sportsWalking_calories = (desired_value_3 + (desired_value_4 * desired_value_5))* self.duration * self.W_T_IN_MIN
...
class Swimming(Training):
    ...
    def get_mean_speed(self) -> float:
        swimming_speed = self.length_pool * self.count_pool / self.M_IN_KM / self.duration
        return swimming_speed

    def get_spent_calories(self) -> float:
        swimming_calories = (self.get_mean_speed() + self.factor_5) * self.factor_6 * self.weight
